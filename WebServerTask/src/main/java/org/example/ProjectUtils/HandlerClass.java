...
import static org.example.commons.HttpServer.HTML_FILE_PATH;
import static org.example.commons.HttpServer.JSON_FILE_PATH;

public class HandlerClass implements Runnable{
    private Socket socket;

    public HandlerClass(Socket socket) {
        this.socket = socket;
    }
